 ...
 * This represents the application resource manager that manages resource creation and lookup.
 * The resources can be injected by the application configuration (not available in
 * this current project) or instantiated in this class.
 */
public class AppManager {
     ...
     */
    public GameManager buildGameManager(Game.GameName game, int height, int width,
        ...
        switch (userManager.getCurrentUser().getCustomization().getMusicPath()) {
            ...
            case SONG2:
                ...
                break;
            case SONG3:
                gameManager.setMusicPlayer(MediaPlayer.create(context,
