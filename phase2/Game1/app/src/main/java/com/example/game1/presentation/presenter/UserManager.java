...
public class UserManager {
  ...
  /**
   * Registers a new User instance with username, userName, and password, password. If registration
  ...
  /**
   * Logs in a User with username, userName, and password, password. If login is successful, return
  ...
  public void updateCurrentUsersCustomization(
      String characterColour, String colourScheme, String music) {
