...
public class BrickMovementInfo extends MovementInfo {
  ...
  /**
   * public Jumper getJumper() { return jumper; }
   *
   * <p>public void setJumper(Jumper jumper) { this.jumper = jumper; }
   *
   * <p>public Terrain getTerrain() { return terrian; }
   *
   * <p>public void setTerrain(Terrain terrian) { this.terrian = terrian; }
   */
}
