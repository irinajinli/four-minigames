 ...
 *
 * <p>It acts like a facade for interactions between each game and the system. (e.g. creating an
...
public class AppManager {
  ...
  public AppleGameManager getAppleGameManager(int height, int width) {
    return (AppleGameManager)
        gameManagerFactory.getGameManager(GameManagerFactory.Game.APPLE, height, width);
  }

  public TappingGameManager getTappingGameManager(int height, int width) {
    return (TappingGameManager)
        gameManagerFactory.getGameManager(GameManagerFactory.Game.TAPPING, height, width);
  }
