...
public class GameManagerFactory {
     ...
     */
    enum Game {APPLE, TAPPING, JUMPING}
    ...
    GameManager getGameManager(Game game, int height, int width) {
        switch(game) {
            ...
            case JUMPING:
                // TODO: return new JumpingGameManager once that class is created. Temporarily, this just creates and returns a AppleGameManager
