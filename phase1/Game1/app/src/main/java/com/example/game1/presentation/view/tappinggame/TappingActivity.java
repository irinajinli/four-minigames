                ...
                new CountDownTimer(10000, 1000) {
                    ...
                    public void onTick(long millisUntilFinished) {
                        ...
                        RelativeLayout.LayoutParams lp =
                                (RelativeLayout.LayoutParams) iv_character.getLayoutParams();

                        if (lp.rightMargin > 0) {
                            lp.leftMargin = lp.leftMargin + (int) speed;

                            lp.rightMargin = lp.rightMargin - (int) speed;

                            iv_character.setLayoutParams(lp);
                        }
                    }
